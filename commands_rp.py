...
def setup_rp_commands(bot: commands.Bot):
    ...
    class InizioTurnoModal(discord.ui.Modal, title="Inizio Turno Lavorativo"):
        ...
        async def on_submit(self, interaction: discord.Interaction):
            try:
                stipendio = int(self.stipendio_input.value.replace(',', '').replace('.', '').strip())
                ...
                embed = discord.Embed(
                    title="<a:online:1459627385702973572> 𝐓𝐮𝐫𝐧𝐨 𝐥𝐚𝐯𝐨𝐫𝐚𝐭𝐢𝐯𝐨 <a:broom:1431606606763921408>",
    ...
    async def fine_turno(interaction: discord.Interaction, lavoro: discord.Role):
        try:
            ...
            embed = discord.Embed(
                title="<a:offline:1459628872197738641> 𝐓𝐮𝐫𝐧𝐨 𝐥𝐚𝐯𝐨𝐫𝐚𝐭𝐢𝐯𝐨 <a:cigarette:1431607423256494161>",
                description=(
