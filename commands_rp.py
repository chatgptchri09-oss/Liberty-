...
# ... (All'inizio della funzione setup_rp_commands(bot: commands.Bot):)
    # Sostituisci solo i comandi RP con questi aggiornati (da inserire nel tuo commands_rp.py)
...
async def anonimo(interaction: discord.Interaction, messaggio: str):
    ...
    log_embed.add_field(name="📝 Messaggio", value=messaggio[:1024], inline=False)  # Max 1024 caratteri
